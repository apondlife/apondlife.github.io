...
>
  <p>
    wanna keep these posts short and respondable, so i'm going to try and
  ...
  <p>
    i want to make something chewier than what we have on this first
    prototype. something that's like 30% stuff the weight of what we have in
    <Link href="/zines/rats" text="rats"/>, 40% stuff thats a bit chewier, and
    30% something quite chewy. where that cheweist 30% is something we could
    reuse issue-to-issue.
  </p>

  <p>
    re. theme, it doesn't seem to me like picking a single theme is a good
  ...
  <p>
    the container that's exciting me most atm is something like mystical ninja
  ...
  <p>
    and i'd like to figure out how to make money. to sustain. to get real. a
