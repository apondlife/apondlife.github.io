      ...
      <div class="EventList">
        <article id="gitg0" class="Event">
          ...
          <div class="Event-body">
            ...
            grass!). even at this first event, <Link text="new" href="/gitg/games#zending" /> <Link text="new" href="/gitg/games#lightbox" /> games were invented!
            it felt vital.
          </div>
        </article>
        ...
        <article id="gitg1" class="Event">
          ...
          <div class="Event-body">
            ...
            <Link text="forkgame" href="/gitg/games#forkgame" />, which we got to play with at least two strangers, and felt great. we also had
        ...
        <article id="gitg2" class="Event">
          ...
          <div class="Event-body">
            ...
            cooperative
            <Link text="balloon relay" href="/gitg/games#balloon-relay" />
